                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <%
                                    ...
                                    %>
                                <hr style="margin: 5px">
                                <a href="employee-profile-edit.jsp" class="btn btn-info pull-right">Edit Profile</a>
                                <br>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <p><%=rs.getString("bank_name")%></p>
                                </div>
                                <div class="col-md-3">
                                    <label>Account Number</label>
                                    <p><%=rs.getString("acc_no")%></p>
                                </div>
                                <div class="col-md-3">
                                    <label>IFSC Code</label>
                                    <p><%=rs.getString("ifsc_code")%></p>
                                </div>
                                 <%
                                    }
                                    %>
