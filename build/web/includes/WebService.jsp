...
//                    session.setAttribute("usertype","employee");
        ...
        case "delete":
            ...
            break;
          case "getbankdetails":
            String eempid=request.getParameter("empid");
            ResultSet resbf=db.getEmployeeById(Integer.parseInt(eempid));
            resbf.next();
            String ot="<center><br><table border='1' cellpadding='10'><tr><th>Bank Name</th><th>Account Number</th><th>IFSC Code</th></tr><tr><td>"+resbf.getString("bank_name")+"</td><td>"+resbf.getString("acc_no")+"</td><td>"+resbf.getString("ifsc_code")+"</td><tr></table></center>";
            out.println(ot);
            break;
        ...
        case "edit-employee-profile":
            String uefsname=request.getParameter("name");
            String uefaddress=request.getParameter("address");
            String uefmobno=request.getParameter("mobno");
            String uefemail=request.getParameter("email");
            String uefdob=request.getParameter("dob");
            String uefbranch=request.getParameter("department");
            String uefdesignation=request.getParameter("designation");
            String bank_name=request.getParameter("bank_name");
            String acc_no=request.getParameter("acc_no");
            String ifsc_code=request.getParameter("ifsc_code");
            int uefid=Integer.parseInt(request.getParameter("efid"));
            
            boolean uefres=db.updateEmployee(uefid,uefsname,uefaddress,uefmobno,uefemail,uefdob,uefbranch,uefdesignation,bank_name,acc_no,ifsc_code);
            if(uefres){
                response.sendRedirect("../employee-profile-edit.jsp?status=1&id="+uefid);
            }else{
                response.sendRedirect("../employee-profile-edit.jsp?status=0&id="+uefid);
            }
            break;
        case "changepass":
