                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <table class="table">
                                    <tr>
                                        <th>Sr.No.</th><th>Amount</th><th>Deduction</th><th>Month</th><th>Date</th>
                                    </tr>
                                    <%
                                    ...
                                    %>
                                    <tr>
                                        <td><%=i++%></td><td><%=rs.getString("amount")%></td><td><%=rs.getString("deduction")%></td><td><%=rs.getString("month")%></td>
