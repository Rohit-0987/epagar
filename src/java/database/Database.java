...
public class Database
{
    ...
    public Database() throws SQLException
    {
        try{
            ...
            con=DriverManager.getConnection("jdbc:mysql://localhost:3306/epagar","root","12345678");
     ...
     public ResultSet getSessionById(int id)
    {
     ...
     public boolean updateEmployee(int id,String sname,String address,String mobno,String email,String dob,String branch,String design,String bankname,String accno,String ifsccode){
         try {
            pst=con.prepareStatement("update employee set name=?,address=?,mobile=?,email=?,dob=?,department_id=?,designation=?,bank_name=?,acc_no=?,ifsc_code=?,status=? where id=?");
            pst.setString(1, sname);
            pst.setString(2, address);
            pst.setString(3, mobno);
            pst.setString(4, email);
