                ...
                <div class="container">
                    ...
                    try{
                                ...
                                status=request.getParameter("status");
                                                    ...
                                                    if(status.equals("2"))
                                                    {
                                                        out.println("<p style='color:green; text-align:center;'>Password reset successfully! Please login.</p>");
                                                    }
                             }
                    catch(Exception e){}
                                    %>
                    ...
                    <div class="col-lg-5">
                        <div class="panel">
                            <div class="panel-body" style="border:1px solid #1a5ef5; color:#000; border-radius: 50px">
                                <center><label style="font-size: 20px; color:#000 ">Employee Login Here</label></center>
                                <hr>
                                ...
                                <div class="form-group"> 
                                  <div class="col-sm-offset-2 col-sm-10 text-center">
                                    ...
                                    <a href="forget-password.jsp" style="color:#000;">Forgot Password?</a>
                                  </div>
                                </div>
                              </form>
                            </div>
